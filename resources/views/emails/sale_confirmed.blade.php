                    ...
                    <tr>
                        <td style="background:#0D1F1A;border-radius:16px;border:1px solid rgba(255,255,255,0.08);padding:40px 36px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" style="padding-bottom:24px;">
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="width:52px;height:52px;background:rgba(99,179,237,0.10);border:1px solid rgba(99,179,237,0.25);border-radius:12px;text-align:center;vertical-align:middle;font-size:22px;">
                                                    🏷️
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <p style="margin:0 0 28px;color:rgba(255,255,255,0.45);font-size:14px;text-align:center;line-height:1.6;">
                                Hi {{ $transaction->user->name }}, your sale has been processed successfully.
                            </p>

                            {{-- Amount highlight --}}
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:16px;">
                                <tr>
                                    <td style="background:rgba(99,179,237,0.08);border:1px solid rgba(99,179,237,0.2);border-radius:12px;padding:20px;text-align:center;">
                                        <p style="margin:0 0 4px;color:rgba(99,179,237,0.6);font-size:10px;font-weight:700;letter-spacing:0.2em;text-transform:uppercase;">
                                            Amount Received
                                        </p>
                                        <p style="margin:0;color:#63B3ED;font-size:28px;font-weight:800;letter-spacing:-0.5px;">
                                            &#x20A6;{{ number_format($transaction->amount_kobo / 100, 2) }}
                                        </p>
                                    </td>
                                </tr>
                            </table>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="padding:5px 0;border-bottom:1px solid rgba(255,255,255,0.06);">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td style="color:rgba(255,255,255,0.4);font-size:12px;text-align:left;">Property</td>
                                            ...
                                            <tr>
                                                <td style="padding:5px 0;border-bottom:1px solid rgba(255,255,255,0.06);">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td style="color:rgba(255,255,255,0.4);font-size:12px;text-align:left;">Units Sold</td>
                            ...
                            <p style="margin:0;color:rgba(255,255,255,0.35);font-size:13px;text-align:center;line-height:1.6;">
                                The proceeds have been credited to your wallet and are available for withdrawal.
                            </p>
                        </td>
                    </tr>
