                    ...
                    <tr>
                        <td style="background:#0D1F1A;border-radius:16px;border:1px solid rgba(255,255,255,0.08);padding:40px 36px;">
                            ...
                            <p style="margin:0 0 28px;color:rgba(255,255,255,0.45);font-size:14px;text-align:center;line-height:1.6;">
                                Hi {{ $withdrawal->user->name }}, your withdrawal request has been processed successfully.
                            </p>
                                ...
                                <tr>
                                    <td style="background:rgba(59,180,118,0.08);border:1px solid rgba(59,180,118,0.2);border-radius:12px;padding:20px;text-align:center;">
                                        ...
                                        <p style="margin:0;color:#3BB476;font-size:28px;font-weight:800;letter-spacing:-0.5px;">
                                            &#x20A6;{{ number_format($withdrawal->amount_kobo / 100, 2) }}
                                        </p>
                                    </td>
                                </tr>
                            </table>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="padding:5px 0;border-bottom:1px solid rgba(255,255,255,0.06);">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td style="color:rgba(255,255,255,0.4);font-size:12px;text-align:left;">Bank</td>
                                                            <td style="color:#ffffff;font-size:13px;font-weight:500;text-align:right;">{{ $withdrawal->bank_name }}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:5px 0;border-bottom:1px solid rgba(255,255,255,0.06);">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td style="color:rgba(255,255,255,0.4);font-size:12px;text-align:left;">Account Number</td>
                                                            <td style="color:#ffffff;font-size:13px;font-weight:500;text-align:right;">
                                                ...
                                                <td style="padding:5px 0;border-bottom:1px solid rgba(255,255,255,0.06);">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="color:#ffffff;font-size:13px;font-weight:500;text-align:right;">{{ $withdrawal->date }}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                ...
                                                <td style="padding:5px 0;">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="color:rgba(200,135,58,0.85);font-size:12px;font-weight:600;text-align:right;font-family:monospace;">{{ $withdrawal->reference }}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
