                    ...
                    <tr>
                        <td style="background:#0D1F1A;border-radius:16px;border:1px solid rgba(255,255,255,0.08);padding:40px 36px;">
                                ...
                                <tr>
                                    <td align="center" style="padding-bottom:24px;">
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="width:52px;height:52px;background:rgba(200,135,58,0.12);border:1px solid rgba(200,135,58,0.25);border-radius:12px;text-align:center;vertical-align:middle;font-size:22px;">
                                                    ✅
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <p style="margin:0 0 28px;color:rgba(255,255,255,0.45);font-size:14px;text-align:center;line-height:1.6;">
                                Hi {{ $transaction->user->name }}, your purchase has been successfully processed.
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                                <tr>
                                    <td style="background:rgba(200,135,58,0.08);border:1px solid rgba(200,135,58,0.2);border-radius:12px;padding:24px;text-align:center;">
                                        <p style="margin:0 0 12px;color:rgba(200,135,58,0.6);font-size:10px;font-weight:700;letter-spacing:0.2em;text-transform:uppercase;">
                                            Purchase Details
                                        </p>
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="padding:5px 0;border-bottom:1px solid rgba(255,255,255,0.06);">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td style="color:rgba(255,255,255,0.4);font-size:12px;text-align:left;">Land</td>
                                                            <td style="color:#ffffff;font-size:13px;font-weight:500;text-align:right;">{{ $transaction->land->title }}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:5px 0;border-bottom:1px solid rgba(255,255,255,0.06);">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td style="color:rgba(255,255,255,0.4);font-size:12px;text-align:left;">Units Purchased</td>
                                                            <td style="color:#ffffff;font-size:13px;font-weight:500;text-align:right;">{{ $transaction->units }}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:5px 0;border-bottom:1px solid rgba(255,255,255,0.06);">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td style="color:rgba(255,255,255,0.4);font-size:12px;text-align:left;">Total Paid</td>
                                                            <td style="color:#ffffff;font-size:13px;font-weight:500;text-align:right;">&#x20A6;{{ number_format($transaction->amount_kobo / 100, 2) }}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                ...
                                                <td style="padding:5px 0;border-bottom:1px solid rgba(255,255,255,0.06);">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="color:#ffffff;font-size:13px;font-weight:500;text-align:right;">{{ $transaction->date }}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                ...
                                                <td style="padding:5px 0;">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="color:rgba(200,135,58,0.85);font-size:12px;font-weight:600;text-align:right;font-family:monospace;">{{ $transaction->reference }}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ rtrim(config('app.frontend_url', '#'), '/') }}/portfolio"
                            ...
                            <p style="margin:0;color:rgba(255,255,255,0.35);font-size:13px;text-align:center;line-height:1.6;">
                                If you did not authorize this purchase, please contact our support team immediately.
                            </p>
                        </td>
                    </tr>
