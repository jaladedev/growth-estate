                    ...
                    <tr>
                        <td style="background:#0D1F1A;border-radius:16px;border:1px solid rgba(255,255,255,0.08);padding:40px 36px;">
                                ...
                                <tr>
                                    <td align="center" style="padding-bottom:24px;">
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="width:52px;height:52px;background:rgba(200,135,58,0.12);border:1px solid rgba(200,135,58,0.25);border-radius:12px;font-size:22px;line-height:52px;text-align:center;vertical-align:middle;">
                                                    🔐
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                                <tr>
                                    <td style="background:rgba(200,135,58,0.08);border:1px solid rgba(200,135,58,0.2);border-radius:12px;padding:24px 16px;text-align:center;">
                                        ...
                                        <p style="margin:0;color:#E8A850;font-size:36px;font-weight:800;letter-spacing:0.18em;font-family:'Courier New',monospace;text-align:center;">
                                            {{ $code }}
                                        </p>
                                    </td>
                                </tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                                <tr>
                                    <td style="background:rgba(251,191,36,0.06);border:1px solid rgba(251,191,36,0.12);border-radius:10px;padding:14px 16px;text-align:center;">
                                        <p style="margin:0;color:rgba(251,191,36,0.7);font-size:13px;text-align:center;line-height:1.5;">
                                            This code expires in <strong style="color:#fbbf24;">10 minutes</strong>. Please complete the reset promptly.
                                        </p>
                                    </td>
                                </tr>
                            </table>
